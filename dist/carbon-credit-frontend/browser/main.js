...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-QLVGANMU.js").then((m) => m.authRoutes)
  },
  {
    path: "admin",
    canActivate: [authGuard, adminGuard],
    loadChildren: () => import("./chunk-MFTV5OJO.js").then((m) => m.adminRoutes)
  },
  {
    path: "dashboard",
    canActivate: [authGuard],
    loadChildren: () => import("./chunk-LYBFJW44.js").then((m) => m.companyRoutes)
  },
  {
    path: "marketplace",
    canActivate: [authGuard],
    loadChildren: () => import("./chunk-4HUREMTD.js").then((m) => m.marketplaceRoutes)
  },
  {
    path: "**",
    redirectTo: "/auth/login"
